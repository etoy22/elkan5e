...
export function tools(){
    ...
    CONFIG.DND5E.tools.painter.id = "Compendium.elkan5e.elkan5e-mundane-items.qZe6ua1j3TtX3QGv";
    CONFIG.DND5E.tools.sculpt = {"ability": "dex", "id": "Compendium.Compendium.elkan5e.elkan5e-mundane-items.Item.6x1yyzDnWGRNRwJD"}
